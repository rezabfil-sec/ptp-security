...
/**
 * Obtain the Security Policy Database associated with a clock.
 * @param c  The clock instance.
 * @return   The pointer to the clock's SPD. 
 */
security_policy_db *clock_get_spd(struct clock *c);

/**
 * Obtain the Security Association Database associated with a clock.
 * @param c  The clock instance.
 * @return   The pointer to the clock's SAD. 
 */
security_association_db *clock_get_sad(struct clock *c);
